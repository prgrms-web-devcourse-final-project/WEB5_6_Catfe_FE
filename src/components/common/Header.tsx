...
import { useLogout } from '@/hook/useAuthActions';
...
function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full h-[56px] flex items-center justify-between px-10 border-b border-[var(--color-primary-500)] bg-[var(--color-background-base)] transition-transform duration-300 ${
        ...
        <div className="flex items-center gap-5 relative">
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <Image
                  src={user.profile.profileImageUrl || '/image/cat-default.svg'}
                  alt="profile"
                  width={36}
                  height={36}
