...
export const PLAN_SWATCH: Record<ColorEnum, { fill: string; border: string; text: string }> = {
  RED: { fill: 'bg-rose-200', border: 'border-rose-500/40', text: 'text-neutral-900' },
  ORANGE: { fill: 'bg-orange-200', border: 'border-orange-500/40', text: 'text-neutral-900' },
  YELLOW: { fill: 'bg-amber-200', border: 'border-amber-500/40', text: 'text-neutral-900' },
  GREEN: { fill: 'bg-emerald-200', border: 'border-emerald-500/40', text: 'text-neutral-900' },
  BLUE: { fill: 'bg-sky-200', border: 'border-sky-500/40', text: 'text-neutral-900' },
  PURPLE: { fill: 'bg-violet-200', border: 'border-violet-500/40', text: 'text-neutral-900' },
  PINK: { fill: 'bg-pink-200', border: 'border-pink-500/40', text: 'text-neutral-900' },
};
